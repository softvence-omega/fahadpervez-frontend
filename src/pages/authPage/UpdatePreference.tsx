...
export default function UpdatePreference({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log("verify profession :", filteredData);
    onNext(filteredData);
        ...
        <div className="border border-slate-300 rounded-lg p-4 bg-white">
          ...
          <div className="space-y-2">
            {[
              ...
              const startTime = availability[dayKey].startTime;
              const endTime = availability[dayKey].endTime;
                ...
                >
                  <div className="flex items-center gap-3 flex-1">
                    <input
                      ...
                      checked={isEnabled}
                      onChange={(e) => {
                        updateAvailability(dayKey, "enabled", e.target.checked);
                        if (!e.target.checked) {
                          updateAvailability(dayKey, "startTime", "");
                          updateAvailability(dayKey, "endTime", "");
                        }
                      }}
                      className="w-4 h-4"
                    />
