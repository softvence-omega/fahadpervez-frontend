...
export default function FlashCard({
  ...
  return (
    <div className="flex flex-col justify-between p-5 border border-slate-300 rounded-[12px] h-full">
      ...
      <button
        ...
        className="w-full rounded-[4px] py-3 flex justify-center gap-1 items-center bg-emerald-800 text-white cursor-pointer mt-auto"
      >
