...
const questions: Question[] = [
    {
        ...
        options: [
            ...
            { value: "C", label: "C. Wearing loose cotton clothing", isCorrect: false },
        ...
        explanation: {
            ...
            references: "Reference: Robbins Basic Pathology, 10th Edition, Chapter 23.",
        },
    },
    {
        id: "02",
        ...
        explanation: {
            ...
            references: "Guyton and Hall Textbook of Medical Physiology, 14th Edition.",
        },
    },
    {
        id: "03",
        ...
        <div className="p-6 space-y-8">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <DashboardHeading
                        title={`Anatomy Essentials MCQ's`}
                        titleSize="text-xl"
                        description={`${questions.length} Question | Uploaded By: DR.Root Silva`}
                        className="space-y-1"
                    />
                </div>
            ...
            {questions.map((q, idx) => {
                ...
                return (
                    <div key={q.id} className="border border-slate-300 rounded-lg p-5 space-y-4">
                        <div>
