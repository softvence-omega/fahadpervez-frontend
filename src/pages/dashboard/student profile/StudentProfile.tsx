...
import { Activity, BrainCog, BriefcaseMedical, CircleCheck, FileBadge2 } from "lucide-react"
                    ...
                    <table className="w-full border-collapse mt-6">
                        ...
                        <tbody>
                            <tr className="border-b border-b-slate-400">
                                <td className="text-[#374151] px-4 py-4">Cardiovascular System</td>
                            ...
                            <tr>
                                <td className="text-[#374151] px-4 py-4">Microbiology System</td>
                                <td className="flex items-center gap-2 px-4 py-4">
                                    <div className="relative w-40 h-2 bg-red-600 rounded-full overflow-hidden">
                                        <div
                                            className="absolute left-0 top-0 h-full bg-green-500"
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="space-y-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <h2 className="text-xl font-medium text-zinc-700">Diagnostic Accuracy</h2>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <h2 className="text-xl font-medium text-zinc-700">Treatment Selection</h2>
                                <div className="flex items-center gap-6">
                                    <Progress value={90} />
                                    90%
                                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <h2 className="text-xl font-medium text-zinc-700">Risk Assessment</h2>
                                <div className="flex items-center gap-6">
                                    <Progress value={90} />
                                    90%
                                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <h2 className="text-xl font-medium text-zinc-700">Follow-up Planning</h2>
                                <div className="flex items-center gap-6">
                                    <Progress value={90} />
                                    90%
                                </div>
