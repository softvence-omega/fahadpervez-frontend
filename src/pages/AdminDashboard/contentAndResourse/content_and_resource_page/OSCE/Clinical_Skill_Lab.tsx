...
import Section from "@/components/AdminDashboard/Content & Resource_Component/OSCE/Clinik Skill/Section";
import Badge from "@/components/AdminDashboard/Content & Resource_Component/OSCE/Clinik Skill/Badge";
import VideoButton from "@/components/AdminDashboard/Content & Resource_Component/OSCE/Clinik Skill/VideoButton";
import ChecklistSection from "@/components/AdminDashboard/Content & Resource_Component/OSCE/Clinik Skill/ChecklistSection";
...
const Clinical_Skill_Lab: React.FC<Clinical_Skill_LabProps> = ({ onBack }) => {
  ...
  const checklistSections = [
    ...
    },
    {
      ...
      title: "Inspection",
      items: [
        "General appearance-appointment",
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start mb-6 rounded-lg border border-slate-300 bg-white p-4">
          <div className="flex-1">
            ...
            <p className="text-gray-600 text-sm">
              Practice the complete CVS examination from introduction to final
              summary.
            </p>
          </div>
          <div className="mt-2 lg:mt-0 text-right flex justify-center items-center gap-1">
            <span className="text-xs text-gray-500">Time</span>
            <span className="text-gray-900 font-medium text-base leading-6">
              15:00
            </span>
          </div>
        </div>
            ...
            <Section title="Candidate Instructions">
              <ul className="space-y-2 text-sm text-gray-700">
                <li className="flex gap-2">
                  ...
                  <span>
                    You are a medical student working in the emergency
                    department
                  </span>
                </li>
                <li className="flex gap-2">
            ...
            <Section title="Patient Script">
              ...
              <div className="space-y-3 mb-4">
                ...
                <ul className="space-y-2 text-sm text-gray-700 ml-4">
                  ...
                  <li>
                    • Site: epigastric ("it's hurts in the middle, right under
                    my ribs")
                  </li>
                  <li>
                    • Suddenly, 90 minutes ago ("it came on suddenly about one
              ...
              <div className="space-y-2 mb-4">
                <p className="text-sm text-gray-700">
                  • Examiner: ("I had appendicitis a few months ago, they put
                  this pain is much worse than that's")
                </p>
                <p className="text-sm text-gray-700">
                  • Gestational diabetes in first diabetics which I was pregnant
                  with both my children, but my blood sugar wasn't back to
                  normal afterwards")
                </p>
              </div>
