...
const DashboardCard1 = ({
  ...
  return (
    ...
    >
      {/* Header Section */}
      <div className="flex md:flex-col lg:flex-row  items-center justify-between mb-6 gap-2">
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 border rounded-lg font-medium text-sm transition-colors duration-200 hover:bg-gray-50 ${
      ...
      >
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={onStartQuiz}
            className="flex items-center gap-2 px-4 py-2 bg-gray-800 text-white rounded-lg hover:bg-gray-900 transition-colors duration-200 font-medium"
          >
