            ...
            <div className="p-6">
                <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0">
                        <h2 className="uppercase tracking-wide text-[#0A0A0A] font-semibold text-sm md:text-base truncate">{title}</h2>
                        <span className="inline-block mt-1 text-sm md:text-base font-medium text-[#030213] bg-[#ECEEF2] px-2 py-1 rounded">{subtitle}</span>
                    </div>
                </div>
                <p className="mt-3 mb-4 text-[#717182] text-sm md:text-base">{description}</p>

                <div className="mt-4 bg-[#ECECF0] px-3 py-2 rounded-lg">
                    <h3 className="font-semibold text-[#0A0A0A] mb-1 text-sm md:text-base">Scenario:</h3>
                ...
                <div className="mt-6 flex flex-col md:flex-row gap-2">
                    <button
                        ...
                        className="flex-1 flex items-center justify-center gap-2 px-3 py-2.5 border-2 border-slate-300 text-[#0A0A0A] text-xs md:text-sm font-medium rounded-md hover:bg-slate-50 transition-colors"
                    >
                    ...
                    {/* <button
                        onClick={onSimulate}
                        className="flex-1 flex items-center justify-center gap-2 px-3 py-2.5 bg-[#ECEEF2] text-[#0A0A0A] text-xs md:text-sm font-medium rounded-md hover:bg-[#E2E4E8] transition-colors"
                    >
