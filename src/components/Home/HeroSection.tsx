      ...
      <CommonWrapper>
        <div className="md:grid grid-cols-2 gap-10 items-center">
          <div className="py-10 md:py-16" >
            ...
            <div className="grid grid-cols-2 gap-4 my-6 md:my-8 lg:my-10 max-w-md">
              <div className=" rounded-lg border bg-blue-50 border-[#0EA5E94D]/30 p-4 md:p-5">
                <img src={heroIcon1} alt="heroIcon" />
                <h3 className="text-sm md:text-lg lg:text-xl font-semibold text-blue-800 mt-2 text-nowrap">Medical student</h3>
              </div>

              <div className=" rounded-lg border bg-blue-50 border-[#0EA5E94D]/30 p-4 md:p-5">
                <img src={heroIcon2} alt="heroIcon" />
                <h3 className="text-sm md:text-lg lg:text-xl font-semibold text-blue-800 mt-2 text-nowrap">Nursing student</h3>
              </div>
            </div>
